  ...
  return (
    <div className="max-w-screen-lg mx-auto flex justify-center">
      <div className="flex flex-col items-center justify-center w-[547px] h-[282px] gap-4 ">
        <h2 className="text-blackUi text-t32 text-center lg:text-left font-bold font-montserrat capitalize">
          Start your 14 days free trial
        </h2>
        <p className="font-montserrat text-xl leading-6 tracking-wide text-center">
