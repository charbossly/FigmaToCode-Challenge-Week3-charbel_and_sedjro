...
export default function index({ title, subtitle, source, destination }) {
  ...
  return (
    <div className="max-w-screen-lg mx-auto flex flex-col justify-center items-center py-24 gap-y-8">
      <h4 className="text-t24 text-center text-grayUi uppercase">{subtitle}</h4>
      <h1 className="text-t50 text-center text-black font-bold">{title}</h1>
